...
### __Contexte de jeu__
- __Jeux de la série déjà faits :__ *Fire Emblem* __(GBA)__, *FE : The Sacred Stones* __(GBA)__, *FE : Shadow Dragon* __(NDS)__, *FE : Awakening* __(3DS)__, le début de *FE Fates : Héritage*.
...
<p class="no-indent"><img src="/img/fire_emblem_path_of_radiance/01.jpg" alt="Vue d'une bataille" width="100%"></p></p>
...
<p class="no-indent"><img src="/img/fire_emblem_path_of_radiance/02.jpg" alt="La longue liste de personnages" width="100%"></p>
...
<p class="no-indent"><img src="/img/fire_emblem_path_of_radiance/03.jpg" alt="Une séquence de dialogue" width="100%"></p>
...
<p class="no-indent"><img src="/img/fire_emblem_path_of_radiance/04.jpg" alt="Les cinématiques 3D viennent ponctuer avec justesse la narration" width="100%"></p>
...
[Let's Play Fire Emblem: Path of Radiance]: https://www.youtube.com/playlist?list=PLTWdDQXld2aLq5Lbn5Fks6KMHs1Rs0mmA&disable_polymer=true